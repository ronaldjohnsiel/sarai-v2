...
Meteor.startup(() => {
  ...
  if (WeatherStations.find().count() === 0) {
    ...
    WeatherStations.insert({ stationID : 'ILOSBAOS2', label : 'SARAI NCAS UP Los Banos Laguna (UPLB)', lat : 4.166, long : 121.241, enabled: true, region: 'IV-A' })
    WeatherStations.insert({ stationID : 'ICALABAR18', label : 'SARAI IPB, Laguna (UPLB), Los Baños', lat : 4.156224, long : 121.262199, enabled: true, region: 'IV-A' })
    ...
    WeatherStations.insert({ stationID : 'IDAVAORE20', label : 'SARAI SPAMAST Buhangin Malita Davao Occidental (UPLB) ', lat : 6.726, long : 121.699, enabled: true, region: 'XI' })
